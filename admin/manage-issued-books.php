...
<head>
    ...
    <title>CTAE Library Management System | Manage Issued Books</title>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="update-issue-bookdeails.php?rid=<?php echo htmlentities($result->rid);?>"><button class="btn btn-primary"> Return</button> 
