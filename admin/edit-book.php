...
$sql="update  tblbooks set BookName=:bookname,CatId=:category,AuthorId=:author,ISBNNumber=:isbn,BookPrice=:price, BookCopies=:bookcopies, PublisherName=:publisher, Available=:selectoption where id=:bookid";
...
$query->bindParam(':selectoption',$selectoption,PDO::PARAM_STR);
$query->execute();
...
<head>
    ...
    <title>CTAE Library Management System | Edit Book</title>
...
<p class="help-block">An ISBN is an International Standard Book Number.ISBN Must be unique</p>
 ...
 <div class="form-group">
 <label>Book Copies<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="bookcopies" value="<?php echo htmlentities($result->BookCopies);?>"   required="required" />
 </div>
  <div class="form-group">
 <label>Publisher<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="publisher" value="<?php echo htmlentities($result->PublisherName);?>"   required="required" />
 </div>
  <div class="form-group">
<label>AVAILABLE<span style="color:red;">*</span></label>
<select custom-select custom-select-lg name="selectoption" required="required" autocomplete="off">
