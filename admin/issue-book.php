...
$studentid=strtoupper($_POST['studentid']);
$sql2 = "UPDATE tblstudents set TotalIssued=TotalIssued+1 WHERE StudentId=:studentid";
$query2 = $dbh->prepare($sql2);
$query2->bindParam(':studentid',$studentid,PDO::PARAM_STR);
$query2->execute();


$sql1 = "UPDATE tblbooks set BookCopies=BookCopies-1 WHERE id=:bookid";
...
<head>
    ...
    <title>CTAE Library Management System | Issue a new Book</title>
